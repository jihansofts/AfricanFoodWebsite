...
const data: WhyChooseUsProps[] = [
  {
    ...
    title: "Fast Delivery",
    desc: "It is a long established fact that a reader will be distracted by the readable content of a page when tters, as opposed to usingIt is a long established fact that a reader ",
    bg: "#FFF6F6",
    bColer: "#F6A8A8",
  },
  {
